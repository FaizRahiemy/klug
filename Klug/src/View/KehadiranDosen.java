 ...
 * @author faiz
 */
public class KehadiranDosen extends javax.swing.JFrame implements View{

    /**
     * Creates new form Login
     */
    public KehadiranDosen() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tanggal.setFont(new java.awt.Font("Aller", 0, 24)); // NOI18N
            ...
            .addGroup(backgroundKlug1Layout.createSequentialGroup()
                ...
                .addGroup(backgroundKlug1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(backgroundKlug1Layout.createSequentialGroup()
                        ...
                        .addGap(58, 58, 58)
                        .addComponent(tanggal, javax.swing.GroupLayout.PREFERRED_SIZE, 211, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void close1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_close1MouseReleased
        this.setState(KehadiranDosen.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KehadiranDosen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KehadiranDosen().setVisible(true);
            }
        });
