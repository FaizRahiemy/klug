 ...
 * @author faiz
 */
public class ControllerPilihKelasNilaiDosen implements ActionListener{
    private PilihKelas pilKel = null;
    private Application app;
    private FileIO file;
    private int userId;
    
    public ControllerPilihKelasNilaiDosen(Application app, FileIO file, int userId){
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(x.equals(pilKel.getBtn_back())){
            ...
            ControllerPilihNilaiDosen tugasMhs = new ControllerPilihNilaiDosen(app,file,userId,pilKel.getPilihKelas().getSelectedIndex());
        }
        pilKel.dispose();
    }
}
